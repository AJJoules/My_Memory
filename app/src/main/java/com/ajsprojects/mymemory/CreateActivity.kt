...
import com.ajsprojects.mymemory.utils.*
...
class CreateActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == READ_EXTERNAL_PHOTOS_CODE){
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this, "In order to create a custom game, please allow permissions to access photos", Toast.LENGTH_LONG).show()
            }
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode != PICK_PHOTO_CODE || resultCode != Activity.RESULT_OK || data == null){
            Log.w(TAG, "Did not get data back from the launched activity, user cancelled")
            return
        }
    ...
    private fun saveDataToFirebase() {
        ...
        // In the event of it being created before
        db.collection("games").document(customGameName).get().addOnSuccessListener { document ->
            ...
            Toast.makeText(this, "Encountered error while saving game memory", Toast.LENGTH_SHORT).show()
        }
    ...
    private fun getImageByteArray(photoUri: Uri): ByteArray {
        ...
        Log.i(TAG, "Scaled width Height ${scaledBitMap.width} and height ${originalBitmap.height}")
